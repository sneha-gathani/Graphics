...
public:
    ...
    //return the stored pdf which has area of triangle/total area for each triangle
    DiscretePDF getTrianglePDF() const { return m_pdf1;}
    //return the total emitter area
...
protected:
    ...
    //object of the discrete pdf class for supporting faster calculations
    DiscretePDF m_pdf1;
    float pdf;
    float mesharea;
};
